...
/*
            ...
            if (nodeNameEquals(item, "collectionProp")) {
                ...
                if (params instanceof List) {
                    for (Object p : (List) params) {
                        ...
                        elementProp.addAttribute("name", (String) jsonObject.get("name"));
                        elementProp.addAttribute("elementType", "Argument");
                        appendStringProp(elementProp, "Argument.name", (String) jsonObject.get("name"));
                        // 处理 mock data
    ...
    private void processBackendListener(Element backendListener) {
        ...
        TestResourcePool resourcePool = CommonBeanFactory.getBean(BaseTestResourcePoolService.class).getResourcePool(resourcePoolId);
